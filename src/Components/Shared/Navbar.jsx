...
const Navbar = () => {
  ...
  const navItemStyle =
    "px-4 py-2 mt-2 text-[18px] font-medium rounded-lg md:mt-0 md:ml-2 hover:underline underline-offset-8 focus:outline-none focus:shadow-outline";
  ...
  return (
    <div className="overflow-hidden max-w-[1120px] mx-auto ">
      <div className="relative z-50 hidden lg:block">
        <div className="w-full text-[#212327] dark:text-neutral bg-transparent py-2 shadow">
          <div className="flex flex-col px-4 mx-auto lg:items-center lg:justify-between lg:flex-row md:px-6 lg:px-8">
            ...
            {/* Navigation Links */}
            <nav className="flex flex-grow justify-center mx-auto">
              <div className="flex flex-grow justify-center mx-auto">
                ...
                <NavLink className={navItemStyle} to="/templates">
                  Templates
                </NavLink>
              ...
              <div className="flex justify-end ml-auto gap-4">
                <Link
                  className="primary-btn-style text-[14px] font-medium"
                  to="/contact"
                >
                  Contact Us
                </Link>
                ...
                <button
                  onClick={toggleTheme}
                  className="px-4 py-2 font-semibold text-sm rounded-md bg-primary text-white hover:bg-secondary"
                >
                  Toggle Theme
                </button>
              </div>
